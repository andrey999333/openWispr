...
function heroHtml({ eyebrow, h1, subhead, ctaNote }) {
  ...
  <div class="ow-hero" style="position:relative; max-width:820px; margin:0 auto; padding:50px 32px 60px; text-align:center;">
    ...
    <div style="display:flex; align-items:center; justify-content:center; gap:13px; flex-wrap:wrap;">
      <a href="${ANDROID_DOWNLOAD_URL}" style="display:inline-flex; align-items:center; gap:10px; font-size:15.5px; font-weight:600; color:oklch(0.985 0.012 82); background:oklch(0.66 0.13 40); padding:14px 22px; border-radius:12px; box-shadow:0 10px 24px -10px oklch(0.55 0.13 38 / 0.7);">Get it on Google Play</a>
      <a href="${MACOS_DOWNLOAD_URL}" style="display:inline-flex; align-items:center; gap:10px; font-size:15.5px; font-weight:600; color:oklch(0.32 0.03 47); background:oklch(0.995 0.006 85); border:1px solid oklch(0.88 0.014 70); padding:14px 22px; border-radius:12px;">Download for macOS</a>
    </div>
...
function footerCtaHtml() {
  ...
  <div style="max-width:820px; margin:0 auto; padding:80px 32px; text-align:center;">
    ...
    <p style="font-size:17px; line-height:1.6; color:oklch(0.84 0.03 70); margin:0 auto 30px; max-width:480px;">Open source and entirely on your device. Install from Google Play on Android, or download the macOS app from GitHub Releases — no account, no sign-up.</p>
    <div style="display:flex; align-items:center; justify-content:center; gap:13px; flex-wrap:wrap;">
      <a href="${ANDROID_DOWNLOAD_URL}" style="display:inline-flex; align-items:center; gap:10px; font-size:16px; font-weight:600; color:oklch(0.3 0.04 35); background:oklch(0.98 0.012 82); padding:15px 26px; border-radius:13px;">Get it on Google Play</a>
      <a href="${MACOS_DOWNLOAD_URL}" style="display:inline-flex; align-items:center; gap:10px; font-size:16px; font-weight:600; color:oklch(0.96 0.012 82); background:oklch(0.4 0.04 35 / 0.45); border:1px solid oklch(0.54 0.05 40); padding:15px 26px; border-radius:13px;">Download for macOS</a>
    </div>
  </div>
</div>`;
}
