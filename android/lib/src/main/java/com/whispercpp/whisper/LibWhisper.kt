...
class WhisperContext private constructor(private var ptr: Long) {
    ...
    suspend fun transcribeData(data: FloatArray, printTimestamp: Boolean = true, prompt: String? = null, language: String? = null): String = withContext(scope.coroutineContext) {
        require(ptr != 0L)
...
private class WhisperLib {
    companion object {
        ...
        external fun fullTranscribe(contextPtr: Long, numThreads: Int, audioData: FloatArray, prompt: String?, language: String?)
